ALTER TABLE `maps` ADD `modified_at` integer DEFAULT 1730419200 NOT NULL;--> statement-breakpoint
...
SELECT m.id AS map_id, lmv.lat, lmv.lng, lmv.heading, lmv.pitch, lmv.zoom, lmv.pano_id, lmv.meta_name,
       ...
       lmv.meta_note_from_plonkit, lmv.meta_id, max(lmv.max_modified_at, m.modified_at) as max_modified_at
