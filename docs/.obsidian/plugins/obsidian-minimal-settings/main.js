  ...
  E = (n, t, s) => {
    if ((t && typeof t == 'object') || typeof t == 'function')
      for (let l of W(t))
        !N.call(n, l) &&
          l !== 'default' &&
          u(n, l, { get: () => t[l], enumerable: !(s = L(t, l)) || s.enumerable });
    return n;
  },
  y = (n) =>
    E(
...
var a = y(require('obsidian')),
  ...
  b = class extends a.PluginSettingTab {
    ...
    display() {
      ...
      d.appendChild(createEl('span', { text: 'To create a custom color scheme use the ' })),
        d.appendChild(
          createEl('a', {
            text: 'Style Settings',
      ...
      m.appendChild(createEl('span', { text: 'See ' })),
        m.appendChild(createEl('a', { text: 'documentation', href: 'https://minimal.guide' })),
        ...
        new a.Setting(t)
          ...
          .addToggle((i) =>
            i.setValue(this.plugin.settings.colorfulActiveStates).onChange((e) => {
      ...
      r.appendChild(
        createEl('span', { text: 'These options can also be defined on a per-file basis, see ' })
      ),
        r.appendChild(
          createEl('a', {
            text: 'documentation',
        ...
        t.createEl('br'),
        t.createEl('div', { text: 'Typography', cls: 'setting-item setting-item-heading' }),
        new a.Setting(t)
...
var S = class extends C.Plugin {
  onload() {
    return p(this, null, function* () {
      yield this.loadSettings(), this.addSettingTab(new b(this.app, this)), this.loadRules();
      let t = () => {
          ...
          this.app.vault.getConfig('foldHeading')
            ? ((this.settings.folding = !0), console.log('Folding is on'), (e = !0))
            : ((this.settings.folding = !1), console.log('Folding is off')),
            this.app.vault.getConfig('showLineNumber')
              ? ((this.settings.lineNumbers = !0), console.log('Line numbers are on'), (w = !0))
              : ((this.settings.lineNumbers = !1), console.log('Line numbers are off')),
        ...
        s = () => {
          ...
          this.settings.lightStyle == 'minimal-light-contrast'
            ...
            : i && e && (i.removeClass('theme-dark'), e.removeClass('theme-dark'));
        };
      ...
      this.addCommand({
        ...
        this.addCommand({
          ...
          callback: () => {
            (this.settings.darkStyle = d[(d.indexOf(this.settings.darkStyle) + 1) % d.length]),
              this.saveData(this.settings),
        ...
        this.addCommand({
          ...
          callback: () => {
            (this.settings.lightStyle = l[(l.indexOf(this.settings.lightStyle) + 1) % l.length]),
              this.saveData(this.settings),
        ...
        this.addCommand({
          ...
          callback: () => {
            (this.settings.tableWidth = g[(g.indexOf(this.settings.tableWidth) + 1) % g.length]),
              this.saveData(this.settings),
              this.refresh();
          }
        }),
        this.addCommand({
          ...
          callback: () => {
            (this.settings.imgWidth = h[(h.indexOf(this.settings.imgWidth) + 1) % h.length]),
              this.saveData(this.settings),
              this.refresh();
          }
        }),
        this.addCommand({
          ...
          callback: () => {
            (this.settings.iframeWidth = m[(m.indexOf(this.settings.iframeWidth) + 1) % m.length]),
              this.saveData(this.settings),
              this.refresh();
          }
        }),
  ...
  unloadRules() {
    ...
    t && t.parentNode.removeChild(t), document.body.classList.remove('minimal-theme');
  }
  setFontSize() {
    this.app.vault.setConfig('baseFontSize', this.settings.textNormal), this.app.updateFontSize();
  }
  updateStyle() {
    this.removeStyle(),
      this.removeSettings(),
  ...
  updateDarkStyle() {
    document.body.removeClass(
      ...
      this.app.vault.getConfig('theme') !== 'system' &&
        (this.app.setTheme('obsidian'), this.app.vault.setConfig('theme', 'obsidian')),
  ...
  updateLightStyle() {
    document.body.removeClass(
      ...
      this.app.vault.getConfig('theme') !== 'system' &&
        (this.app.setTheme('moonstone'), this.app.vault.setConfig('theme', 'moonstone')),
      this.app.workspace.trigger('css-change');
  }
  updateDarkScheme() {
  ...
  updateTheme() {
    if (this.app.vault.getConfig('theme') === 'system')
      document.body.classList.contains('theme-light')
        ? (document.body.removeClass('theme-light'), document.body.addClass('theme-dark'))
        : (document.body.removeClass('theme-dark'), document.body.addClass('theme-light'));
    else {
      document.body.classList.contains('theme-light')
        ? (document.body.removeClass('theme-light'), document.body.addClass('theme-dark'))
        : (document.body.removeClass('theme-dark'), document.body.addClass('theme-light'));
      let s = this.app.vault.getConfig('theme') === 'moonstone' ? 'obsidian' : 'moonstone';
