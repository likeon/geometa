...
select mgl.*, m.id as meta_id, m.tag_name as meta_tag_name, m.name as meta_name, m.note as meta_note, m.note_html as meta_note_html, m.note_from_plonkit as meta_note_from_plonkit, m.has_image as meta_has_image, m.modified_at as meta_modified_at
